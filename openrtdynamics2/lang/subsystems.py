...
#         output_signal_of_embedding_system = dy.SubsystemOutputLinkUser( dy.get_system_context().UpperLevelSim, output_signal )
...
#         embeddedingBlockPrototype = bp.GenericSubsystem( sim=dy.get_system_context().UpperLevelSim, 
